...
int ReadNum(); // Read Number from command 
void PrintNum(int arg); // Print Number to Command
char ReadChar(); // Read Character from command
void PrintChar(char character); // Print character to command 
int RandomNum(); // random the positive number to command
void ReadString(char *buffer, int length); // Read string to buffer
